...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFilesystem", path: "../../../node_modules/.pnpm/@capacitor+filesystem@7.1.4_@capacitor+core@7.4.4/node_modules/@capacitor/filesystem"),
        ...
        .package(name: "CapacitorPluginSafeArea", path: "../../../node_modules/.pnpm/capacitor-plugin-safe-area@4.0.2_@capacitor+core@7.4.4/node_modules/capacitor-plugin-safe-area"),
