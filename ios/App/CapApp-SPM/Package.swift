...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityAppIcon", path: "../../../node_modules/.pnpm/@capacitor-community+app-icon@6.0.0_@capacitor+core@8.0.0/node_modules/@capacitor-community/app-icon"),
        ...
        .package(name: "CapacitorAndroidNavMode", path: "../../../node_modules/.pnpm/capacitor-android-nav-mode@2.0.0_@capacitor+core@8.0.0/node_modules/capacitor-android-nav-mode"),
        .package(name: "CapacitorApplicationContext", path: "../../../node_modules/.pnpm/capacitor-application-context@2.0.0_@capacitor+core@8.0.0/node_modules/capacitor-application-context"),
        .package(name: "CapacitorBiometricLock", path: "../../../node_modules/.pnpm/capacitor-biometric-lock@2.0.0_@capacitor+core@8.0.0/node_modules/capacitor-biometric-lock"),
        .package(name: "CapacitorClearCache", path: "../../../node_modules/.pnpm/capacitor-clear-cache@2.0.0_@capacitor+core@8.0.0/node_modules/capacitor-clear-cache"),
        .package(name: "CapacitorLaunchNative", path: "../../../node_modules/.pnpm/capacitor-launch-native@2.0.0_@capacitor+core@8.0.0/node_modules/capacitor-launch-native"),
        ...
        .package(name: "CapacitorStashMedia", path: "../../../node_modules/.pnpm/capacitor-stash-media@3.2.3_@capacitor+core@8.0.0/node_modules/capacitor-stash-media"),
