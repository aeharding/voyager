...
import registrationApplicationSlice from "./features/registration-applications/registrationApplicationSlice";
...
const store = configureStore({
  reducer: {
    ...
    registrationApplication: registrationApplicationSlice,
  },
});
